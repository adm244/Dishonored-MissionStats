...
DEFINE_STATIC_POINTER(detour_setmissionstats, 0x00BD3BE0);
DEFINE_STATIC_POINTER(detour_shouldskipmustdoflag, 0x00BD42F1);
...
DEFINE_STATIC_POINTER(hook_setmissionstats_ret, 0x00BD3BE6);
DEFINE_STATIC_POINTER(hook_shouldskipmustdoflag_ret, 0x00BD42F7);
